...
<div class="layout">
	<div class="header">
		...
		<div class="slider_header page_slider">
			...
			if(is_page()){ 
			 ...
			 <?php }else if(is_category()){
			 	 ...
			 	 $slider = get_field('slider',  'category_'.$cat_ID); 

			 } ?>
			
			<?php if($slider){ ?>
				<div class="header_carousel clearfix"> 
					<?php foreach($slider as $slide_img){ ?>
						<div class="item">
							<?php $img = wp_get_attachment_image($slide_img['slide_img']['id'], 'slide_img_page'); ?>
			...
			<?php }else { ?>
				<div class="header_img_block clearfix"> 
					<img src="<?php bloginfo('template_url'); ?>/images/cousel_slide.jpg">
				</div>
